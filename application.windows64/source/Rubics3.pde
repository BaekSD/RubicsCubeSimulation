...
class MatlabCube
{
  ...
  void setting() throws MatlabConnectionException, MatlabInvocationException
  {
    proxy = factory.getProxy();
    proxy.eval("variables");
  }

  void eval(String str) throws MatlabConnectionException, MatlabInvocationException
  {
    proxy.eval(str);
  }

  void solving() throws MatlabConnectionException, MatlabInvocationException
  {
  ...
  void returnCubeStatus() throws MatlabConnectionException, MatlabInvocationException
  {
...
class Cube
{
  ...
  void drawCube(int s, float angle)
  {
    for (int i=0; i<cp.length; i++)
    {
